...
if($_POST){
	...
	if (
			...
			|| ! wp_verify_nonce( $_REQUEST['_wpnonce'],'add-smtp' )
	) {
		wp_nonce_ays( 'add-smtp');
		exit;
...
// 		if(is_email($_POST['xyz_em_SmtpEmailAddress'])){
			...
			if(isset($_POST['xyz_em_SmtpSetDefault']) && sanitize_text_field($_POST['xyz_em_SmtpSetDefault']) == "on"){
