<?php
/**
 * Brando Custom Switch For VC.
 *
 * @package Brando
 */
?>
<?php 
vc_add_shortcode_param( 'brando_custom_switch_option', 'brando_custom_switch_option_settings_field', BRANDO_ADDONS_ROOT_DIR . '/brando-shortcodes/js/custom.js');
function brando_custom_switch_option_settings_field( $settings, $value ) {
