...
function brando_custom_et_line_icon($settings, $value) {
  $css_option = vc_get_dropdown_option( $settings, $value );
  $counter_icons_list = brando_get_et_line_icon();
...
vc_add_shortcode_param('brando_et_line_icon', 'brando_custom_et_line_icon');
if( !function_exists('brando_get_et_line_icon')) {
  function brando_get_et_line_icon() {
