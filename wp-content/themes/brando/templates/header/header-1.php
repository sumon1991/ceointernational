...
?>
    <nav class="navbar no-margin-bottom alt-font<?php echo esc_attr($brando_header_text_color);?>">
        <div class="container navigation-menu">
            <div class="row">
                ...
                ?>
                    <div class="col-lg-3 col-md-2 pull-right header-right text-right sm-display-none testest">
