            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 text-center margin-three-bottom xs-margin-eight-bottom">
                    ...
                    <?php if($brando_footer_text): ?>
                        <span class="text-small alt-font text-uppercase margin-one-tb xs-margin-six-top display-block letter-spacing-1 black-text"><?php echo esc_attr($brando_footer_text); ?></span>
                     <?php endif; ?>
                </div>
                <?php } ?>
                <!-- end footer logo -->
