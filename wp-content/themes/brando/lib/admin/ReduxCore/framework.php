...
// Exit if accessed directly
    ...
    /* Defind to remove theme check error */
    defined('REDUX_PAGE_SLUG') or define('REDUX_PAGE_SLUG', 'page');
    defined('REDUX_ADMIN_MENU_SLUG') or define('REDUX_ADMIN_MENU_SLUG', 'add_menu');

    if ( ! class_exists( 'ReduxFrameworkInstances' ) ) {
        // Instance Container
        require_once get_template_directory().'/lib/admin/ReduxCore/inc/class.redux_instances.php';
        require_once get_template_directory().'/lib/admin/ReduxCore/inc/lib.redux_instances.php';
    }
...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework' ) ) {
        ...
        // Redux CDN class
        require_once get_template_directory().'/lib/admin/ReduxCore/inc/class.redux_cdn.php';

        // Redux API class  :)
        require_once get_template_directory().'/lib/admin/ReduxCore/inc/class.redux_api.php';

        // General helper functions
        require_once get_template_directory().'/lib/admin/ReduxCore/inc/class.redux_helpers.php';

        // General functions
        require_once get_template_directory().'/lib/admin/ReduxCore/inc/class.redux_functions.php';
        require_once get_template_directory().'/lib/admin/ReduxCore/inc/class.p.php';

        require_once get_template_directory().'/lib/admin/ReduxCore/inc/class.thirdparty.fixes.php';

        require_once get_template_directory().'/lib/admin/ReduxCore/inc/class.redux_filesystem.php';

        require_once get_template_directory().'/lib/admin/ReduxCore/inc/class.redux_admin_notices.php';

        // ThemeCheck checks
        require_once get_template_directory().'/lib/admin/ReduxCore/inc/themecheck/class.redux_themecheck.php';
        ...
        class ReduxFramework {
            ...
            public static function init() {
                ...
                $dir = Redux_Helpers::cleanFilePath( get_template_directory().'/lib/admin/ReduxCore' );
            ...
            public function __construct( $sections = array(), $args = array(), $extra_tabs = array() ) {
                ...
                if ( empty ( $this->args['footer_credit'] ) ) {
                    $url = 'http://wpdemos.themezaa.com/brando';
...
// __construct()
            ...
            private function _internationalization() {
                 ...
                 * @param string     'brando'  text domain
                 */
                $locale = apply_filters( "redux/textdomain/{$this->args['opt_name']}", get_locale(), 'brando' );
...
// get_instance()
            ...
            private function _tracking() {
                if ( file_exists( get_template_directory().'/lib/admin/ReduxCore/inc/tracking.php' ) ) {
                    require_once get_template_directory().'/lib/admin/ReduxCore/inc/tracking.php';
...
// show()
            ...
            private function add_submenu( $page_parent, $page_title, $menu_title, $page_permissions, $page_slug ) {
                ...
                if ( isset ( $test[ $page_parent ] ) ) {
                    ...
                    if ( true == $addMenu ) {
                        ...
                        $admin_page = REDUX_PAGE_SLUG.'_'.REDUX_ADMIN_MENU_SLUG;
                        $this->page = call_user_func( $admin_page, $page_parent, $page_title, $menu_title, $page_permissions, $page_slug, array(
                            &$this,
                            'generate_panel'
                        ) );
                    }
            ...
            public function _options_page() {
                ...
                if ( $this->args['menu_type'] == 'hidden' ) {
                    ...
                    $admin_page = REDUX_PAGE_SLUG.'_'.REDUX_ADMIN_MENU_SLUG;
                    $this->page = call_user_func( $admin_page, $this->args['page_title'], $this->args['menu_title'], $this->args['page_permissions'], $this->args['page_slug'], array(
                        &$this,
                        'generate_panel'
                    ...
                    if ( true === $this->args['allow_sub_menu'] ) {
                        if ( ! isset ( $section['type'] ) || $section['type'] != 'divide' ) {
                            foreach ( $this->sections as $k => $section ) {
                                ...
                                // ONLY for non-wp.org themes OR plugins. Theme-Check alert shown if used and IS theme.
                                call_user_func( $admin_page, $this->args['page_slug'], $section['title'], $section['title'], $this->args['page_permissions'], $this->args['page_slug'] . '&tab=' . $k,
            ...
            public function _admin_bar_menu() {
                ...
                if ( $menu ) {
                    ...
                    $nodeargs = array(
                        ...
                        'title' => $title,
                        // $theme_data->get( 'Name' ) . " " . __( 'Options', 'brando' ),
...
// _register_settings()
            ...
            private function _register_extensions() {
                $path    = get_template_directory().'/lib/admin/ReduxCore/inc/extensions/';
