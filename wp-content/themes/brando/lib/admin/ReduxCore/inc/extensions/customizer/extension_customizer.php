        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                if ( empty( $this->_extension_dir ) ) {
                    $this->_extension_dir = trailingslashit( str_replace( '\\', '/', get_template_directory().'/lib/admin/ReduxCore/inc/extensions/customizer' ) );
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Redux_Customizer_Section' ) ) {
                    require_once get_template_directory().'/lib/admin/ReduxCore/inc/extensions/customizer/inc/customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
                    require_once get_template_directory().'/lib/admin/ReduxCore/inc/extensions/customizer/inc/customizer_panel.php';
                ...
                if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
                    require_once get_template_directory().'/lib/admin/ReduxCore/inc/extensions/customizer/inc/customizer_control.php';
                }

                require_once get_template_directory().'/lib/admin/ReduxCore/inc/extensions/customizer/inc/customizer_fields.php';
                require_once get_template_directory().'/lib/admin/ReduxCore/inc/extensions/customizer/inc/customizer_devs.php';
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => esc_html__( 'You have changes that are not saved. Would you like to save them now?', 'brando' ),
                    'reset_confirm'  => esc_html__( 'Are you sure? Resetting will lose all custom values.', 'brando' ),
                    'preset_confirm' => esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'brando' ),
